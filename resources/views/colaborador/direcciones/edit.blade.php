    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <form method="POST" action="{{ route('colaborador.direcciones.update', $direccion) }}">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label for="nombre_direcciones" class="block text-sm font-medium text-gray-700 mb-2">
                        Nombre de la Dirección <span class="text-red-500">*</span>
                    </label>
                    <input type="text" 
                           id="nombre_direcciones" 
                           name="nombre_direcciones" 
                           value="{{ old('nombre_direcciones', $direccion->nombre_direcciones) }}"
                           required
                           maxlength="100"
                           class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 @error('nombre_direcciones') border-red-500 @enderror">
                ...
                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                    <input type="checkbox" 
                           ...
                           name="i_active" 
                           value="1"
                           {{ old('i_active', $direccion->i_active) ? 'checked' : '' }}
