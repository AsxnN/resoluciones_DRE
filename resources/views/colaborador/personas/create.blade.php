    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Complete todos los datos del personal</p>
            </div>
        </div>
    </div>

    <!-- Formulario -->
    <form method="POST" action="{{ route('colaborador.personas.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('apellido_paterno_persona') }}"
                           required
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('apellido_materno_persona') }}"
                           required
                ...
                <div>
                    ...
                    <select id="sexo_persona" 
                        ...
                        <option value="M" {{ old('sexo_persona') == 'M' ? 'selected' : '' }}>Masculino</option>
                        <option value="F" {{ old('sexo_persona') == 'F' ? 'selected' : '' }}>Femenino</option>
                    </select>
                    @error('sexo_persona')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('fecha_nacimiento_persona') }}"
                           required
                           max="{{ date('Y-m-d') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="id_tipo_personal" 
                        ...
                        <option value="{{ $tipo->id }}" {{ old('id_tipo_personal') == $tipo->id ? 'selected' : '' }}>
                            {{ $tipo->nombre }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="cargo_persona" 
                           name="cargo_persona" 
                           value="{{ old('cargo_persona') }}"
                           required
                           placeholder="Ej: Docente, Director, Especialista"
                ...
                <div>
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('fecha_ingreso_persona') }}"
                           required
                           max="{{ date('Y-m-d') }}"
                ...
                <div>
                    ...
                    <select id="nivel_educativo_persona" 
                        ...
                        <option value="secundaria" {{ old('nivel_educativo_persona') == 'secundaria' ? 'selected' : '' }}>Secundaria</option>
                        <option value="tecnico" {{ old('nivel_educativo_persona') == 'tecnico' ? 'selected' : '' }}>Técnico</option>
                        <option value="bachiller" {{ old('nivel_educativo_persona') == 'bachiller' ? 'selected' : '' }}>Bachiller</option>
                        <option value="licenciatura" {{ old('nivel_educativo_persona') == 'licenciatura' ? 'selected' : '' }}>Licenciatura</option>
                        <option value="maestria" {{ old('nivel_educativo_persona') == 'maestria' ? 'selected' : '' }}>Maestría</option>
                        <option value="doctorado" {{ old('nivel_educativo_persona') == 'doctorado' ? 'selected' : '' }}>Doctorado</option>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="estado_civil_persona" 
                        ...
                        <option value="">Seleccionar</option>
                        <option value="soltero" {{ old('estado_civil_persona') == 'soltero' ? 'selected' : '' }}>Soltero/a</option>
                        <option value="casado" {{ old('estado_civil_persona') == 'casado' ? 'selected' : '' }}>Casado/a</option>
                        <option value="viudo" {{ old('estado_civil_persona') == 'viudo' ? 'selected' : '' }}>Viudo/a</option>
                        <option value="divorciado" {{ old('estado_civil_persona') == 'divorciado' ? 'selected' : '' }}>Divorciado/a</option>
                        <option value="conviviente" {{ old('estado_civil_persona') == 'conviviente' ? 'selected' : '' }}>Conviviente</option>
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    @error('foto_persona')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Formatos permitidos: JPG, PNG. Máximo 2MB</p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="observaciones_persona" 
                              ...
                              class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 @error('observaciones_persona') border-red-500 @enderror">{{ old('observaciones_persona') }}</textarea>
