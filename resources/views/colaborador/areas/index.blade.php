...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Administración de áreas organizacionales</p>
        </div>
        @can('areas.crear')
        <a href="{{ route('colaborador.areas.create') }}"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm text-gray-900">#{{ $area->id_area }}</span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm font-medium text-gray-900">{{ $area->nombre_area }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        @if($area->i_active)
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            @can('areas.editar')
                            <a href="{{ route('colaborador.areas.edit', $area) }}"
