<?php
// filepath: app/Http/Controllers/Auth/ClienteLoginController.php
...
class ClienteLoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if ($user->tipo_acceso !== 'cliente') {
            Auth::logout();
            throw ValidationException::withMessages([
                'email' => __('No tiene permisos de cliente.'),
            ]);
        }
        ...
        if (!$user->cliente) {
            Auth::logout();
            throw ValidationException::withMessages([
                'email' => __('No tiene un perfil de cliente asociado.'),
            ]);
        }
        ...
        \App\Models\Auditoria::create([
            ...
            'descripcion' => 'Login cliente exitoso',
        ]);
